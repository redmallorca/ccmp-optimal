...
main_onboarding() {
    ...
    echo "      • Epic #67: PrimeVue Refactor"
    echo "      • Epic #68: DaisyUI Refactor"
    echo "   2. Activate context: ./.claude/scripts/context-manager.sh [epic-number]"
    echo "   3. Or use quick start: ./.claude/scripts/start.sh [epic-number]"
    echo ""
    echo "💡 QUICK START EXAMPLES:"
    echo "   ./.claude/scripts/start.sh 67     # Start Epic #67 (PrimeVue)"
    echo "   ./.claude/scripts/start.sh 68     # Start Epic #68 (DaisyUI)"
    echo ""
